...
RUN_CMD="cd /home/bourgon/pit-stock-llm && pip install -q matplotlib seaborn scikit-learn 'bitsandbytes>=0.43.0' && export LD_LIBRARY_PATH=/usr/local/cuda/lib64:\$LD_LIBRARY_PATH && python -u scripts/submit_job.py \
